...
@section('title', 'Edit Pengajuan TA')
@section('page_title', 'Edit Pengajuan TA')
            ...
            <div class="col-lg-8">
                ...
                <div class="form-section-card">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="judul_pengajuan" id="judul_pengajuan" class="form-control form-input" value="{{ old('judul_pengajuan', $pengajuan->judul_pengajuan) }}" required placeholder="Masukkan judul proposal Tugas Akhir Anda">
                    </div>
                    <div class="form-group mb-4">
                        <label for="dosen_pembimbing_display" class="form-label form-label-emphasized">Dosen Pembimbing 1</label>
                     ...
                     <div class="form-group mb-4">
                        <label for="dosen_penguji1_display" class="form-label form-label-emphasized">Dosen Pembimbing 2 (Opsional)</label>
                        <div class="form-dosen-select">
                            <input type="hidden" name="dosen_penguji1_id" value="{{ old('dosen_penguji1_id', $pengajuan->sidang->dosen_penguji1_id) }}">
                            <input type="text" id="dosen_penguji1_display" class="form-control form-input" value="{{ old('dosen_penguji1_display', $pengajuan->sidang->dosenPenguji1->nama ?? '') }}" readonly placeholder="Klik tombol 'Pilih' untuk mencari dosen">
                            <button type="button" class="btn btn-primary" onclick="openDosenModal('dosenPenguji1Modal')"><i class="fas fa-search me-1"></i> Pilih</button>
                        </div>
                    </div>
                </div>
                ...
                {{-- Dokumen Persyaratan --}}
                <div class="form-section-card">
                    <h3 class="form-section-title"><i class="fas fa-folder-open"></i>Dokumen Persyaratan TA</h3>
                ...
                <div class="status-sidebar">
                    <div class="status-card">
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" name="status_action" value="draft" class="btn btn-warning btn-lg" style="color: #000;"><i class="fas fa-save me-2"></i>Simpan Perubahan</button>
                            <button type="submit" name="status_action" value="finalisasi" class="btn btn-success btn-lg" onclick="return confirm('Apakah Anda yakin ingin memfinalisasi pengajuan ini? Setelah difinalisasi, data tidak dapat diubah kembali.')"><i class="fas fa-check-circle me-2"></i>Finalisasi</button>
