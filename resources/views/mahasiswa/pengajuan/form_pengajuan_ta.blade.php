...
<div class="container-fluid">
    ...
    <div class="main-card">
        <h2 class="form-title"><i class="fas fa-graduation-cap"></i>Formulir Pengajuan Tugas Akhir</h2>
        ...
        <form action="{{ route('mahasiswa.pengajuan.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group mb-4">
                ...
                <div class="form-dosen-select">
                    ...
                    <button type="button" class="btn btn-primary" onclick="openDosenModal('dosenPenguji1Modal')">
                        <i class="fas fa-search me-1"></i> Pilih
                    </button>
                </div>
            </div>
