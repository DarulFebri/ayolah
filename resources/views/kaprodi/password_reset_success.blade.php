{{-- resources/views/kaprodi/password_reset_success.blade.php --}}
...
<div class="success-container">
    ...
    <a href="{{ route('kaprodi.login') }}" class="back-button">Kembali ke Halaman Login</a>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        @if (session('success_message'))
            window.showSuccessModal("{{ session('success_message') }}", "{{ route('kaprodi.login') }}");
        @endif
    });
</script>
@endpush