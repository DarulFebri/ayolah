{{-- resources/views/kaprodi/otp_verify.blade.php --}}

@extends('layouts.auth_layout')

@section('title', 'Verifikasi OTP Kaprodi - SIPRAKTA')
...
<div class="otp-container">
    ...
    <form method="POST" action="{{ route('kaprodi.otp.verify') }}">
        @csrf
    ...
    <div class="resend-otp">
        ...
        <form method="POST" action="{{ route('kaprodi.otp.resend') }}" style="display:inline;">
            @csrf
            <input type="hidden" name="email" value="{{ $email }}">
