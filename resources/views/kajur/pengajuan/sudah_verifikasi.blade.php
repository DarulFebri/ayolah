...
@section('title', 'Pengajuan Sudah Diverifikasi')
@section('page_title', 'Pengajuan Sudah Diverifikasi')
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('kajur.pengajuan.show', $pengajuan->id) }}" class="btn btn-primary">Detail</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
