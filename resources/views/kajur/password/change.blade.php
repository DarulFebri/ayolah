...
@section('title', 'Ubah Kata Sandi Kajur - SIPRAKTA') {{-- Mengatur judul halaman --}}

@section('page_title', 'Ubah Kata Sandi') {{-- Mengatur judul di header kajur.blade.php --}}

@section('content')
    <div class="password-change-card">
        <div class="card-header-custom"><i class="fas fa-lock"></i> Ubah Sandi Anda</div>
        ...
        <form id="passwordForm" action="{{ route('kajur.password.change') }}" method="POST">
            @csrf
            ...
            <div class="text-center" style="margin-top: 15px;">
                <a href="{{ route('kajur.forgot.password.form') }}" class="forgot-password-link">Lupa kata sandi saat ini?</a> {{-- Menggunakan rute kajur --}}
            </div>

            <button type="submit" class="btn-primary-form">Ubah Sandi</button>
        </form>
    </div>
@endsection

@push('styles') {{-- Menggunakan @push('styles') agar gaya digabungkan dengan layout --}}
<style>
    /* --- Root Variables from kajur.blade.php --- */
    :root {
        --primary-100: #e6f2ff;
        --primary-200: #b3d7ff;
        --primary-300: #80bdff;
        ...
        /* Added from changepw.blade.php for consistency */
    ...
    /* --- Keyframe Animations from kajur.blade.php and changepw.blade.php --- */
    @keyframes fadeIn {
        from { opacity: 0; transform: translateY(10px); }
        to { opacity: 1; transform: translateY(0); }
    }

    /* --- Password Change Card (adapted from changepw.blade.php) --- */
    .password-change-card {
        ...
        padding: 2.5rem;
        max-width: 550px;
        margin: 2.5rem auto; /* Center the card */
    ...
    .form-group input {
        width: 100%;
        padding: 1rem 1.2rem; /* Adjusted padding as icons are removed */
        border: 1px solid #ccc;
        border-radius: 10px;
        font-size: 1rem; /* Explicitly set font size to prevent auto-zoom */
    ...
    .form-group input:focus {
        ...
        box-shadow: 0 0 0 4px var(--primary-200); /* More prominent focus shadow */
    }

    .form-group .form-icon { /* Aturan ini disembunyikan karena ikon dihapus dari HTML */
        display: none;
    }
    
    .form-group input:focus + .form-icon { /* Aturan ini disembunyikan karena ikon dihapus dari HTML */
        display: none;
    }
    ...
    /* Alert styles (from kajur.blade.php, adapted for consistency) */
    .alert {
        display: flex;
        align-items: center;
        padding: 1.2rem;
    ...
    /* --- Responsive Design (from kajur.blade.php and change-password.blade.php) --- */
    @media (max-width: 768px) {
        ...
        .form-group .form-icon {
            display: none; /* Ensure icons are hidden on small screens too */
        }
        .btn-primary-form {
            font-size: 1rem;
            padding: 0.75rem;
...
@push('scripts') {{-- Menggunakan @push('scripts') agar skrip digabungkan dengan layout --}}
<script>
