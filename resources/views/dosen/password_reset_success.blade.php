{{-- resources/views/dosen/password_reset_success.blade.php --}}
...
<div class="success-container">
    ...
    <a href="{{ route('dosen.login') }}" class="back-button">Kembali ke Halaman Login</a>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        @if (session('success_message'))
            window.showSuccessModal("{{ session('success_message') }}", "{{ route('dosen.login') }}");
        @endif
    });
</script>
@endpush