{{-- resources/views/dosen/otp_verify.blade.php --}}

@extends('layouts.auth_layout')

@section('title', 'Verifikasi OTP Dosen - SIPRAKTA')
...
<div class="otp-container">
    ...
    <form method="POST" action="{{ route('dosen.otp.verify') }}">
        @csrf
    ...
    <div class="resend-otp">
        ...
        <form method="POST" action="{{ route('dosen.otp.resend') }}" style="display:inline;">
            @csrf
            <input type="hidden" name="email" value="{{ $email }}">
