...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Additional styles from dashboard.blade.php */
        .form-row {
            display: flex;
            margin-bottom: 20px;
            align-items: center;
    ...
    <div class="container">
        <div class="sidebar" id="sidebar">
            <div class="logo-container">
                <img src="{{ asset('assets/images/sipraktawhite2.png') }}" alt="SIPRAKTA Logo" class="logo-img" onerror="this.onerror=null; this.src='{{ asset('images/placeholder_logo.png') }}';">
            </div>
        ...
        <div class="main-content" id="mainContent">
            <div class="header">
                <div class="header-content">
                    ...
                    <h1 class="header-title">@yield('page_title', 'Dashboard Dosen')</h1>
                    <div class="user-profile" id="userProfile" aria-haspopup="true" aria-expanded="false">
                        <img src="{{ Auth::user()->dosen && Auth::user()->dosen->foto_profil ? asset('storage/' . Auth::user()->dosen->foto_profil) : asset('images/default-profile.png') }}"
                        ...
                        <div class="profile-dropdown" id="profileDropdown" role="menu">
                            <a href="{{ route('dosen.profile.edit') }}" class="dropdown-item" role="menuitem">
                                <i class="fas fa-user-circle"></i> Profil Saya
                            </a>
                            <a href="{{ route('dosen.password.change.form') }}" class="dropdown-item" role="menuitem">
