...
<head>
    ...
    <title>SIPRAKTA - @yield('title', 'Dashboard Kajur')</title>
            ...
            <div class="header-content">
                ...
                <div class="user-profile" id="userProfile">
                    ...
                    <div class="profile-dropdown" id="profileDropdown">
                        ...
                        <form action="{{ route('kajur.logout') }}" method="POST" style="display: none;" id="logout-form">
                            @csrf
                        </form>
                    </div>
                </div>
    ...
    <script>
        ...
        function toggleSubmenu(menu, event) {
            ...
            document.querySelectorAll('.menu-item').forEach(item => {
                ...
                if (item.querySelector('.fa-tachometer-alt') && "{{ Request::routeIs('kajur.dashboard') }}" === "1") {
