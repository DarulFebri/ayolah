...
<head>
    ...
    <title>SIPRAKTA - @yield('title', 'Dashboard Kaprodi')</title>
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="stylesheet" href="{{ asset('css/kaprodi_pengajuan.css') }}">
    <style>
        :root {
            --primary-100: #e6f2ff;
            --primary-200: #b3d7ff;
...
<body>
    <div class="container">
        <div class="sidebar" id="sidebar">
            ...
            <a href="{{ route('kaprodi.dashboard') }}" style="text-decoration: none; color: inherit;">
                <div class="menu-item {{ Request::routeIs('kaprodi.dashboard') ? 'active' : '' }} tooltip">
            ...
            <a href="{{ route('kaprodi.profile.edit') }}" style="text-decoration: none; color: inherit;">
                <div class="menu-item {{ Request::routeIs('kaprodi.profile.edit') ? 'active' : '' }} tooltip">
                    <i class="fas fa-user-tie"></i>
                    <span>Kaprodi</span>
                    <span class="tooltiptext">Kaprodi</span>
                </div>
            </a>

            {{-- Menu Pengajuan --}}
            <a href="{{ route('kaprodi.pengajuan.index') }}" style="text-decoration: none; color: inherit;">
                <div class="menu-item tooltip {{ Request::routeIs('kaprodi.pengajuan.*') ? 'active' : '' }}">
                    <i class="fas fa-file-invoice"></i> {{-- Ikon untuk Pengajuan --}}
                    <span>Pengajuan</span>
                    <span class="tooltiptext">Pengajuan</span>
                </div>
            </a>
            <div class="submenu {{ Request::routeIs('kaprodi.pengajuan.*') ? 'show' : '' }}" id="pengajuan-submenu">
                
            </div>
            {{-- Akhir Menu Pengajuan --}}

            <a href="{{ route('kaprodi.notifications.index') }}" style="text-decoration: none; color: inherit;">
                <div class="menu-item {{ Request::routeIs('kaprodi.notifications') ? 'active' : '' }} tooltip">
        ...
        <div class="header">
            <div class="header-content">
                ...
                <div class="user-profile" id="userProfile">
                    <img src="{{ $kaprodi_for_layout && $kaprodi_for_layout->foto_profil ? asset('storage/' . $kaprodi_for_layout->foto_profil) : 'https://ui-avatars.com/api/?name=' . urlencode(Auth::user()->name ?? 'Pengguna') . '&background=1a88ff&color=fff' }}"
                    ...
                    <div class="profile-dropdown" id="profileDropdown">
                        <a href="{{ route('kaprodi.profile.edit') }}" class="dropdown-item">
                            <i class="fas fa-user"></i>
                            <span>Profil Saya</span>
                        </a>
                        <a href="{{ route('kaprodi.password.change.form') }}" class="dropdown-item">
    ...
    <script>
        ...
        function toggleSubmenu(menu, event) {
            ...
            document.querySelectorAll('.menu-item').forEach(item => {
                ...
                if (item.querySelector('.fa-tachometer-alt') && "{{ Request::routeIs('kaprodi.dashboard') }}" === "1") {
