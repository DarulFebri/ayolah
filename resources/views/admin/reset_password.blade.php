{{-- resources/views/admin/reset_password.blade.php --}}

@extends('layouts.auth_layout')

@section('title', 'Atur Ulang Sandi Admin - SIPRAKTA')
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        @if (session('status'))
            window.showSuccessModal("{{ session('status') }}", "{{ route('admin.password.reset.success') }}");
        @endif
        @if (session('error'))
